...
def update(objs, request=None, *args, **kwargs):
    ...
    while True:
        ...
        print("Dataframe filtering opeation_date == notnull")
        ...
        print("Converting operation_date field to datetime field")
        dataframe['operation_date'] = pd.to_datetime(
            dataframe['operation_date'], errors='coerce'
        )
        print("Completed\n")

        print("Dataframe filtering operation_date == notnull")
        dataframe = dataframe.loc[dataframe.operation_date.notnull()]
        print("Completed")
